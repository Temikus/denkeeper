...
Six action kinds: `user_update`, `soul_update`, `create_skill`, `modify_schedule`, `install_tool`, `browser_profile`. Default TTL: 24 h (background worker ticks hourly).
...
- Next: Phase 7 in progress (PRD §20 — remote MCP, security hardening, observability). See PRD §15 for the full roadmap.
